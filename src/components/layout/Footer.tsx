...
export default function Footer() {
    ...
    return (
        <footer className="text-primary-500 mx-10 my-4 flex justify-between">
            <div className="">© 2026 Thyjano Dania | Design and development in collaboration with <a href="#Grunly" className="cursor-pointer text-[#52EEB8] duration-300 hover:scale-105">Grunly</a></div>
